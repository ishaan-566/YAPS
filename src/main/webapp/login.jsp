...
<body>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action='LoginServlet'>
					...
					<div class="wrap-input100 validate-input">
						<input type="checkbox" name="isadmin" value="true"><span style="color:white">&nbsp;Check For Admin Login</span>
					</div>
	...
	<script type="text/javascript">
		<c:set var = "message" value="User not found!!"/>
		<c:if test = "${fn:contains(user, 'Invalid')}">
			alert("${message}");
		</c:if>
	</script>
</body>
