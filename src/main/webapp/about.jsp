...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="HomeServlet?action=about" class="nav-link">About</a></li>
					...
					<div class="ftco-footer-widget mb-4">
						...
						<div class="block-23 mb-3">
							<ul>
								...
								<li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__" data-cfemail="0f666169604f76607a7d6b60626e6661216c6062">[email&#160;protected]</span></span></a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<script src="js/jquery-migrate-3.0.1.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	...
	<script src="js/jquery.easing.1.3.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/jquery.waypoints.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/jquery.stellar.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/owl.carousel.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/jquery.magnific-popup.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/aos.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/jquery.animateNumber.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/bootstrap-datepicker.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/jquery.timepicker.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="js/scrollax.min.js" type="19a7e03d728585efc2420360-text/javascript"></script>>
	<script src="js/main.js" type="19a7e03d728585efc2420360-text/javascript"></script>
	<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/95c75768/cloudflare-static/rocket-loader.min.js" data-cf-settings="19a7e03d728585efc2420360-|49" defer=""></script></body>
	</html>